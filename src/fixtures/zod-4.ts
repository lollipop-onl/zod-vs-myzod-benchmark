...
// --- Records ---
export const recordSchema = z.record(z.string(), z.record(z.string(), z.number()));
...
export const recordIntersectionSchema = z.record(z.string(), z.object({ a: z.string() })).and(z.record(z.string(), z.object({ b: z.number() })));
